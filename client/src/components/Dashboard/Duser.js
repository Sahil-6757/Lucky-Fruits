...
function Duser() {
  ...
  async function getData() {
    axios.get("https://lucky-shop-backend.onrender.com:10000/user").then((resp) => {
      setUser(resp.data);
      console.log(User);
    });
  }
  ...
  const handleDelete = (index) => {
    try {
      axios.delete(`https://lucky-shop-backend.onrender.com:10000:10000/userDelete/${index}`).then((resp) => {
