...
function Dorder() {
  ...
  const getData = () => {
    axios.get("https://lucky-shop-backend.onrender.com:10000/order").then((resp) => {
  ...
  const handleDelete = (e) => {
    axios.delete(`https://lucky-shop-backend.onrender.com:10000:10000/delete-order/${e}`).then((resp) => {});
    getData();
  };
